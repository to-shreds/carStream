/* Bundled QR Code generator. Copyright (c) 2009 Kazuhiko Arase. MIT License. */
(function(global){
'use strict';
var modules = Object.create(null), cache = Object.create(null);
function define(id, fn){ modules[id] = fn; }
function normalize(id){ if(id.indexOf('./')===0) id=id.substring(2); return id; }
function req(id){ id=normalize(id); if(cache[id]) return cache[id].exports; if(!modules[id]) throw new Error('Missing QR module '+id); var module={exports:{}}; cache[id]=module; modules[id](module,module.exports,req); return module.exports; }
...
define('QRCode', function(module,exports,require){
//---------------------------------------------------------------------
...
global.QRCode=req('QRCode'); global.QRErrorCorrectLevel=req('QRErrorCorrectLevel');
})(this);
